...
function getEndpoints(deviceAddress, endpoints) {
    ...
    var e = endpoints.addEndpoint("2", "Valve Status 1", endpointType.genericSensor);
    e.variableTypeId = 1301;
    var e = endpoints.addEndpoint("3", "Valve Status 2", endpointType.genericSensor);
    e.variableTypeId = 1301;
