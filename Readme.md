...
# Parsing + Configuration Script – UC511-DI - Rev. A

This **Parsing + Configuration** script is designed for the **UC511-DI** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – UC511-DI Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **UC511-DI** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
